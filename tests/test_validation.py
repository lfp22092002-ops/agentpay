...
class TestAPIKeyRateLimiter:
    def test_allows_under_limit(self):
        from api.main import _check_api_key_rate_limit, _api_key_requests
    ...
    def test_blocks_at_limit(self):
        from api.main import _check_api_key_rate_limit, API_KEY_RATE_LIMIT
...
class TestInputValidation:
    def test_spend_request_positive_amount(self):
        from api.main import SpendRequest
    ...
    def test_refund_request_requires_tx_id(self):
        from api.main import RefundRequest
        from pydantic import ValidationError
        with pytest.raises(ValidationError):
            RefundRequest()

    def test_transfer_request_validation(self):
        from api.main import TransferRequest
        from pydantic import ValidationError
        # Zero amount
        with pytest.raises(ValidationError):
    ...
    def test_send_usdc_request_valid(self):
        from api.main import SendUsdcRequest
    ...
    def test_send_native_request_max_amount(self):
        from api.main import SendNativeRequest
        from pydantic import ValidationError
        with pytest.raises(ValidationError):
...
class TestCategoryValidation:
    def test_valid_categories(self):
        from api.main import VALID_CATEGORIES
